...
ADD https://s3-eu-west-1.amazonaws.com/testing.packages.blackfire.io/blackfire/2026.8.0%2Bp4-internal/blackfire-linux_${TARGETARCH:-amd64} /usr/local/bin/blackfire
