...
ADD https://s3-eu-west-1.amazonaws.com/testing.packages.blackfire.io/blackfire/2026.9.0%2Bp2-internal/blackfire-linux_${TARGETARCH:-amd64} /usr/local/bin/blackfire
