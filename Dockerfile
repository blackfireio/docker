...
ADD https://s3-eu-west-1.amazonaws.com/testing.packages.blackfire.io/blackfire/2026.5.1%2Bp22-internal/blackfire-linux_${TARGETARCH:-amd64} /usr/local/bin/blackfire
